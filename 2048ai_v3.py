	...
	def board_evaluation_function(self, model):
		...
		if model.get_tile_from_position(1,1) != None:
			...
			if model.get_tile_from_position(1,2) != None:
				if model.get_tile_from_position(1,1).value >= model.get_tile_from_position(1,2).value:
					score += model.get_tile_from_position(1,2).value/2.0
					if model.get_tile_from_position(1,3) != None:
						if model.get_tile_from_position(1,2).value >= model.get_tile_from_position(1,3).value:						
							score += model.get_tile_from_position(1,3).value/4.0
							if model.get_tile_from_position(1,4) != None:
								if model.get_tile_from_position(1,3).value >=model.get_tile_from_position(1,4).value:
									score += model.get_tile_from_position(1,4).value/8.0
									if model.get_tile_from_position(1,5) != None:
										if model.get_tile_from_position(1,4).value>=model.get_tile_from_position(1,5).value:
											score += model.get_tile_from_position(1,5).value/16.0
											if model.get_tile_from_position(1,6) != None:
												if model.get_tile_from_position(1,5).value>=model.get_tile_from_position(1,6).value:
													score += model.get_tile_from_position(1,6).value/32.0
		k=self.model.get_max_tile()/80.0
							...
							if model.get_tile_from_position(1,4) != None:
								if model.get_tile_from_position(1,3).value>=model.get_tile_from_position(1,4).value:
									if model.get_tile_from_position(2,4) != None:
										if model.get_tile_from_position(1,4).value>=model.get_tile_from_position(2,4).value:
											score += model.get_tile_from_position(2,4).value/17.0
